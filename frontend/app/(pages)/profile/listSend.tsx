...
const listData = {
    ...
    creator: {
        ...
        avatarUrl:
            'https://i.pinimg.com/236x/69/e9/35/69e935291a322a9958b0a704bc14b542.jpg',
    },
    albums: [
        {
            id: '1',
        ...
        },
        {
            ...
            year: 2024,
            coverUrl:
                'https://upload.wikimedia.org/wikipedia/en/thumb/d/dd/Beabadoobee_-_This_Is_How_Tomorrow_Moves.png/220px-Beabadoobee_-_This_Is_How_Tomorrow_Moves.png',
        },
        {
            id: '4',
        ...
        },
        {
            ...
            year: 2024,
            coverUrl:
                'https://upload.wikimedia.org/wikipedia/en/thumb/9/93/Kendrick_Lamar_-_GNX.png/220px-Kendrick_Lamar_-_GNX.png',
        },
    ],
};
                    ...
                    <View className="mt-6">
                        {listData.albums.map((album, index) => (
                            <Pressable
                                ...
                                onPress={() => {
                                    router.push(
                                        `/(pages)/profile/tracks/${album.spotifyId}`
                                    );
                                }} //maybe fix later
                            >
